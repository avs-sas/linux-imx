...
#define REG_CCI_REGISTER_LAYOUT_VERSION_R		CCI_REG32(0x0000)
...
#define REG_CCI_DEVICE_VERSION_R			CCI_REG64_LE(0x00d8)
...
#define ALVIUM_FW_GET_CSI_CFG_I2C_R \
	_IOR('V', BASE_VIDIOC_PRIVATE + 18, struct alvium_fw_csi_cfg)
